  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by Otomatis.in?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information Otomatis.in will hold $2 and release it immediately'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'Otomatis.in' : 'Gitroom'}?`
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        `${
          isGeneral ? 'Otomatis.in' : 'Gitroom'
