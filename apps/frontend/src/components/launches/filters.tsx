...
export const Filters = () => {
  ...
  return (
    <div className="text-textColor flex flex-col lg:flex-row gap-[8px] items-stretch lg:items-center select-none">
      <div className="flex flex-wrap flex-1 items-center gap-[10px] w-full">
        <div className="border h-[42px] border-newTableBorder bg-newTableBorder gap-[1px] flex items-center rounded-[8px] overflow-hidden w-full sm:w-auto">
          <div
            onClick={previous}
        ...
        <div className="text-[14px] font-[500] w-full sm:w-auto">
          <div className="text-center flex h-[42px] justify-center sm:justify-start">
            <div
              onClick={setToday}
      ...
      />
      <div className="flex flex-row p-[4px] border border-newTableBorder rounded-[8px] text-[14px] font-[500] w-full sm:w-auto">
        <div
          className={clsx(
