...
export const metadata: Metadata = {
  title: `${isGeneralServerSide() ? 'Otomatis.in' : 'Gitroom'} Preview`,
  description: '',
};
              ...
              <div className="min-w-[55px]">
                ...
                >
                  <div className="max-w-[55px]">
                    <Image
                      src={isGeneralServerSide() ? '/logo.png' : '/logo.svg'}
                      width={55}
                      height={55}
                      alt="Logo"
                    />
                  </div>
                  <div className="text-[28px] font-semibold">{isGeneralServerSide() ? 'Otomatis.in' : 'Gitroom'}</div>
                </Link>
              </div>
            </div>
          </div>
